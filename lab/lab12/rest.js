...
function _list() {
   ...
   request.open("GET", "http://pascal.fis.agh.edu.pl/~9kotlowska/rest/list", true);
   request.send(null);
}
...
function _insert(form)  {
    ...
    request.open("POST", "http://pascal.fis.agh.edu.pl/~9kotlowska/rest/save", true);
    request.send(txt);
}
...
print (id_mongo);
    request.open("DELETE", "http://pascal.fis.agh.edu.pl/~9kotlowska/rest/delete1/"+id_mongo, true);
...
function _update(form) {
    ...
    request.open("PUT", "http://pascal.fis.agh.edu.pl/~9kotlowska/rest/update1/"+id_mongo, true);
    request.send(txt);
}
...
function _search(form) {
   ...
   request.open("GET", "/~9kotlowska/rest/list/", true);
   request.send(null);
}
