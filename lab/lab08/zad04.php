...
if (!$user->_is_logged()) {
    ...
    echo "<p><a href='zad04szukaj.html'>Szukaj uzytkownika</a></p>";
    echo "<p><a href='zad04nowyWpis.html'>Blog uzytkownika - nowy wpis</a></p>";
    echo "<p><a href='zad04listaWpisow.php'>Blog uzytkownika - lista wpisow</a></p>";
